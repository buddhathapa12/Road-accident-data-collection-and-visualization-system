...
function () {
  ...
  _createClass(Graph, [{
    ...
    value: function listRenderer() {
      ...
      var scrollTop = document.querySelector("[contentid='Add Data']").scrollTop;
    ...
    value: function showData(startIndex, count) {
      ...
      var that = this;
      document.querySelector("[contentid='Add Data']").addEventListener("scroll", function () {
        that.listRenderer();
      });
...
function addGraph(polygonPoints) {
  ...
  if (window.Worker) {
    ...
    console.log("No web worker"); //graphData=generatePoints(polygonPoints);
    //graph.addData(graphData);
    //graph.generatePath();
    //showvehicleData();
  }
