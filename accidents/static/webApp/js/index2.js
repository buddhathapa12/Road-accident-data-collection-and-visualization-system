...
exports.default = _default;
},{"../LayerType.js":"../node_modules/ol/LayerType.js","./Layer.js":"../node_modules/ol/layer/Layer.js","./TileProperty.js":"../node_modules/ol/layer/TileProperty.js","../obj.js":"../node_modules/ol/obj.js"}],"../node_modules/ol/layer/VectorTileRenderType.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../webgl.js":"../node_modules/ol/webgl.js","../functions.js":"../node_modules/ol/functions.js","./Atlas.js":"../node_modules/ol/style/Atlas.js"}],"../node_modules/ol/style/TextPlacement.js":[function(require,module,exports) {
"use strict";
...
var map = null; //Data for the view to fit(changes on sidebar resizes)

var fitdata = null; //Previous Screen Size Type
...
onloaded.push(selectListeners); //#endregion
...
function showvehicleData() {
  ...
  for (var j = 0; j < graph.data.length; j++) {
    if (graph.data[j].VehicleCausingAccidentType == 4) {
      var feature = new ol.Feature({
        geometry: new ol.geom.Point(getESPG(graph.data[j].point.long, graph.data[j].point.lat))
      });
      feature.set("icon", true); //feature.setStyle(style);

      feature.setStyle(function (feature, resolution) {
        bikeStyle.getImage().setScale(map.getView().getResolutionForZoom(15) / resolution);
        return bikeStyle;
      });
      features.push(feature);
    }
  ...
  for (var j = 0; j < graph.data.length; j++) {
    if (graph.data[j].VehicleCausingAccidentType == 1) {
      var feature = new ol.Feature({
        geometry: new ol.geom.Point(getESPG(graph.data[j].point.long, graph.data[j].point.lat))
      });
      feature.set("icon", true); //feature.setStyle(style);
      ...
      feature.setStyle(function (feature, resolution) {
        busStyle.getImage().setScale(map.getView().getResolutionForZoom(16) / resolution);
        return busStyle;
      });
      features.push(feature);
    }
  ...
  for (var j = 0; j < graph.data.length; j++) {
    if (graph.data[j].VehicleCausingAccidentType == 0) {
      var feature = new ol.Feature({
        geometry: new ol.geom.Point(getESPG(graph.data[j].point.long, graph.data[j].point.lat))
      });
      feature.set("icon", true); //feature.setStyle(style);
      ...
      feature.setStyle(function (feature, resolution) {
        truckStyle.getImage().setScale(map.getView().getResolutionForZoom(16) / resolution);
        return truckStyle;
      });
      features.push(feature);
    }
  ...
  for (var j = 0; j < graph.data.length; j++) {
    if (graph.data[j].VehicleCausingAccidentType == 3) {
      var feature = new ol.Feature({
        geometry: new ol.geom.Point(getESPG(graph.data[j].point.long, graph.data[j].point.lat))
      });
      feature.set("icon", true); //feature.setStyle(style);
      ...
      feature.setStyle(function (feature, resolution) {
        carStyle.getImage().setScale(map.getView().getResolutionForZoom(16) / resolution);
        return carStyle;
      });
      features.push(feature);
    }
  ...
  map.addLayer(vectorLayer);
} //onloaded.push(showvehicleData);
//#endregion


var style = new _style.Style({
  fill: new _style.Fill({
    color: 'rgba(49, 159, 211, 0.01)'
  }),
  stroke: new _style.Stroke({
    color: 'rgb(49, 159, 211,0.8)',
    width: 1
  })
});
...
function addSingleRegion(data) {
  ...
  data.forEach(function (element) {
    formattedData.push(getESPG(element.long, element.lat));
  });
  var feature = new ol.Feature({
    name: "thing",
    geometry: new ol.geom.Polygon([formattedData])
  });
  feature.set("highlightedAraea", true);
  vectorSource1 = new ol.source.Vector({
    features: [feature]
  });
  var vectorLayer1 = new ol.layer.Vector({
...
var ciclrRad = 20; //var highlight;

var highlightStyle = new _style.Style({
  stroke: new _style.Stroke({
    color: 'rgb(49, 159, 211)',
    width: 3
  })
});
...
onloaded.push(function () {
  ...
  var highlight; //addSingleRegion(fitdata);
  ...
  map.on('pointermove', function (e) {
    if (prvDone == false) return;
    var feature = map.forEachFeatureAtPixel(e.pixel, function (feature) {
      return feature;
    });
    if (feature != null && feature.get('icon') == true) return;
  ...
  document.addEventListener("keydown", function (e) {
    if (document.querySelector("#searchBox") == document.activeElement) return;

    if (e.keyCode == 80) {
      ciclrRad++;
      document.querySelector("#dangerarea").style.width = ciclrRad * 2 + "px";
      document.querySelector("#dangerarea").style.height = ciclrRad * 2 + "px";
    ...
    if (e.keyCode == 65) {
      document.querySelector("#dangerarea").style.display = "block";
      document.querySelector("#dangerarea").style.width = ciclrRad * 2 + "px";
      document.querySelector("#dangerarea").style.height = ciclrRad * 2 + "px";
      document.querySelector("#dangerarea").style.position = "absolute";
      document.addEventListener("mousemove", function (e) {
        document.querySelector("#dangerarea").style.left = e.x - ciclrRad + "px";
        document.querySelector("#dangerarea").style.top = e.y - ciclrRad + "px";
        document.querySelector("#dangerarea").style.width = ciclrRad * 2 + "px";
        document.querySelector("#dangerarea").style.height = ciclrRad * 2 + "px";
      });
      document.addEventListener("mousedown", function (e) {
        document.querySelector("#dangerarea").style.display = "none";
      });
...
function BounceTo(data) {
  var extent = findExtent(data);
  var pos1 = getESPG(extent[0], extent[1]);
  var pos2 = getESPG(extent[2], extent[3]);
  extent = [pos1[0], pos1[1], pos2[0], pos2[1]];
...
function findExtent(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    if (res[0] < data[i].x) res[0] = data[i].x;else if (res[2] > data[i].x) res[2] = data[i].x;
    if (res[1] < data[i].y) res[1] = data[i].y;else if (res[3] > data[i].y) res[3] = data[i].y;
  }
...
onloaded.push(function (e) {
  ...
  document.querySelector(".graphContainer").addEventListener("mousemove", function (e) {
    ...
    var Actualwidth = graphContainer.getBoundingClientRect().width;
...
function addtoSearchPrediction(data, invalidatePrevious) {
  var time = Date.now();
  prvTime = time;
  if (window.innerHeight - 50 < data.length * 41) document.querySelector("#suggestions").style.overflowY = "auto";else document.querySelector("#suggestions").style.overflowY = "hidden";

  if (data.length > allSearchSuggestionsCreated.length) {
    document.querySelector("#suggestions").style.height = data.length * 41 + "px"; //document.querySelector("#suggestions").style.maxHeight = (data.length * 41) + "px";
    ...
    for (var i = 0; i < times; i++) {
      ...
      nitem.innerHTML += "<div class=\"icon\"></div><div class=\"content\">" + data[i].content + "</div>";
      document.querySelector("#suggestions").appendChild(nitem);
      allSearchSuggestionsCreated.push(new Suggestion(data[i].icon, data[i].content, nitem, false, data[i].id));
    }
  } else {
    if (ActiveSuggs < data.length) {
      ...
      setTimeout(function () {
        if (time == prvTime) document.querySelector("#suggestions").style.height = data.length * 41 + "px"; //document.querySelector("#suggestions").style.maxHeight = (data.length * 41) + "px";
      }, 200);
    }
  }
  ...
  for (var i = 0; i < allSearchSuggestionsCreated.length; i++) {
    if (i < data.length) {
      ...
      allSearchSuggestionsCreated[i].id = data[i].id;
...
/*#__PURE__*/
function () {
  function Suggestion(iconType, content, DOMelement, seen, id) {
    ...
    this.id = id;
    this.prvRemoved = null;
    var that = this;
    this.DOMelement.addEventListener("click", function () {
      fitdata = places[that.id].loc;
      addSingleRegion(places[that.id].loc);
      addtoSearchPrediction([]);
      document.querySelector("#searchBox").value = places[that.id].name;
      document.querySelector("#sidebarAndSearchContainer").classList += "sidebarActive";

      if (document.querySelector(".sidebar").getBoundingClientRect().width > 700) {
    ...
    value: function Render() {
      ...
      if (this.seen) {
        if (this.currentVisibility == false) {
          ...
          this.prvRemoved = new Date().getTime();
        ...
        if (this.currentVisibility == true) {
          ...
          this.prvRemoved = time;
          setTimeout(function () {
            if (_this.prvRemoved == time) _this.DOMelement.style.display = "none";
          }, 500);
        }
...
function navigateTo(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    minx = Math.min(data[i].long, minx);
    miny = Math.min(data[i].lat, miny);
    maxx = Math.max(data[i].long, maxx);
    maxy = Math.max(data[i].lat, maxy);
  }

  var extent1 = getESPG(minx, miny);
  var extent2 = getESPG(maxx, maxy);
  map.getView().fit([extent1[0], extent1[1], extent2[0], extent2[1]], {
    duration: 200,
    padding: [20, document.querySelector("#sidebarAndSearchContainer").classList.contains("sidebarActive") ? document.querySelector(".sidebar").getBoundingClientRect().width : 0 + 20, 20, 20]
  });
} //#endregion
//#region Add Marker
...
function addaMarker(data) {
  ...
  var vectorSourcee = new ol.source.Vector({
    features: [feature]
  });
  var vectorLayerr = new ol.layer.Vector({
    source: vectorSourcee,
    style: new ol.style.Style({
      image: new ol.style.Icon({
        anchor: [0.5, 0.87],
        anchorXUnits: 'fraction',
  ...
  map.addLayer(vectorLayerr);
} //#endregion
//#region Add a circle


function AddaCircle(data) {
  var feature = new ol.Feature({
    geometry: new ol.geom.Point([data.x, data.y])
  });
  var vectorSourcee = new ol.source.Vector({
  ...
  document.querySelector(".expander").addEventListener("mousedown", function (e) {
    ...
    document.onmousemove = function (e) {
      ...
      if (nx > 500) {
        ...
        document.querySelector(".sidebar").style.minWidth = 500 + "px";
        document.querySelector("#searchBoxContainer").style.minWidth = 500 + "px";
        document.querySelector("#whiteRect").style.width = 500 + "px";
      }
    ...
    document.onmouseup = function (e) {
      ...
      graph.generaterangeChanger(0, 23);
      graph.generatePath();
      e = e || window.event;
      if (e.stopPropagation) e.stopPropagation();
      if (e.preventDefault) e.preventDefault();
...
function inputboxEvent() {
  document.querySelector("#searchBox").addEventListener("keyup", function (e) {
    ...
    if (prvsearchVal == e.target.value) return;
    findallIn(e.target.value);
  });
}

function findallIn(text) {
  var res = [];
  ...
  for (var j = 0; j < places.length; j++) {
    ...
    for (i = 0; i < text.length; i++) {
      if (places[j]['name'].length < i || places[j]['name'][i].toLowerCase() != text[i].toLowerCase()) break;
    }

    if (i == text.length) {
      res.push({
        icon: 0,
        content: places[j]['name'],
        id: j
      });
    }
  }

  addtoSearchPrediction(res, false);
}

onloaded.push(inputboxEvent); //#endregion
//#region Graph Chart
...
function () {
  function Graph(container, table) {
    ...
    this.sortby = "";
    var allheaders = table.querySelector(".one").children;
    this.generaterangeChanger(0, 23);
    var that = this;

    for (var i = 0; i < allheaders.length; i++) {
      if (allheaders[i].classList.contains("VCausingType")) {
        allheaders[i].addEventListener("click", function (e) {
          if (that.sortby == "") {
            that.sortby = "VCausingType";
            that.tableContent.classList += " itemActive";
            that.generatePath(false);
          } else {
            that.sortby = "";
            that.tableContent.classList.remove("itemActive");
            that.generatePath(false);
          }
        });
      } else if (allheaders[i].classList.contains("Time")) {
        allheaders[i].addEventListener("click", function (e) {
          if (that.sortby == "") {
            that.sortby = "time";
            that.tableContent.classList += " item2Active";
            document.querySelector(".rangeChanger").style.display = "block";
            that.generaterangeChanger(0, 23);
            that.generatePath(false);
          } else {
            that.sortby = "";
            document.querySelector(".rangeChanger").style.display = "none";
            that.tableContent.classList.remove("item2Active");
            that.generatePath(false);
          }
        });
      }
      ...
      document.onmousemove = function (e) {
        window.requestAnimationFrame(function () {
          ...
          if (that.LargestXIndex - that.SmallestXIndex <= 5 && change < 0) {
            ...
            if (change > 5) that.LargestXIndex += change;else that.LargestXIndex += change / Math.abs(change);
            if (that.LargestXIndex >= that.dataindexmapped.length - 2) that.LargestXIndex = that.dataindexmapped.length - 2;
            that.generatePath(true);
            prvx = e.x;
          }
  ...
  _createClass(Graph, [{
    ...
    key: "generatemapper",
    value: function generatemapper() {
      var i = 0;
      var len = this.mostLargestX.date.year - this.mostSmallestX.date.year;

      for (var year = 0; year < len; year++) {
        var presentyear = this.mostSmallestX.date.year + year;

        for (var month = 1; month <= 12; month++) {
          var Presentmonth = year * 12 + (month - 1);
          this.dataindexmapped[Presentmonth].startx = i;
          this.dataindexmapped[Presentmonth].VehicleCausingAccidentTypeMonthly = {
            a: 0,
            b: 0,
            c: 0,
            d: 0,
          ...
          this.dataindexmapped[Presentmonth].TimeSortedMonthly = {
            zero: 0,
            one: 0,
            two: 0,
            three: 0,
          ...
          for (var day = 1; day <= 31; day++) {
            if (this.data[i].date.month != month || this.data[i].date.year != presentyear) {
              //TODO: write here
              continue;
            } else if (this.data[i].date.day != day) {
              continue;
            }

            var VehicleCausingAccidentType = {
              a: [],
              b: [],
              c: [],
              d: [],
            ...
            while (this.data[i].date.day == day && this.data[i].date.month == month && this.data[i].date.year == presentyear) {
              switch (this.data[i].VehicleCausingAccidentType) {
                case 1:
                  VehicleCausingAccidentType.a.push(i);
                  this.dataindexmapped[Presentmonth].VehicleCausingAccidentTypeMonthly.a++;
                  break;

                case 2:
                  VehicleCausingAccidentType.b.push(i);
                  this.dataindexmapped[Presentmonth].VehicleCausingAccidentTypeMonthly.b++;
                  break;

                case 3:
                  VehicleCausingAccidentType.c.push(i);
                  this.dataindexmapped[Presentmonth].VehicleCausingAccidentTypeMonthly.c++;
                  break;

                case 4:
                  VehicleCausingAccidentType.d.push(i);
                  this.dataindexmapped[Presentmonth].VehicleCausingAccidentTypeMonthly.d++;
                  break;

                case 5:
                  VehicleCausingAccidentType.e.push(i);
                  this.dataindexmapped[Presentmonth].VehicleCausingAccidentTypeMonthly.e++;
                  break;

                case 6:
                  VehicleCausingAccidentType.f.push(i);
                  this.dataindexmapped[Presentmonth].VehicleCausingAccidentTypeMonthly.f++;
                  break;

                case 7:
                  VehicleCausingAccidentType.g.push(i);
                  this.dataindexmapped[Presentmonth].VehicleCausingAccidentTypeMonthly.g++;
                  break;
              }

              switch (this.data[i].time.hour) {
                case 0:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.zero++;
                  break;

                case 1:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.one++;
                  break;

                case 2:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.two++;
                  break;

                case 3:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.three++;
                  break;

                case 4:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.four++;
                  break;

                case 5:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.five++;
                  break;

                case 6:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.six++;
                  break;

                case 7:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.seven++;
                  break;

                case 8:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.eight++;
                  break;

                case 9:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.nine++;
                  break;

                case 10:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.ten++;
                  break;

                case 11:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.eleven++;
                  break;

                case 12:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.twelve++;
                  break;

                case 13:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.thirteen++;
                  break;

                case 14:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.forteen++;
                  break;

                case 15:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.fifteen++;
                  break;

                case 16:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.sixteen++;
                  break;

                case 17:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.seventeen++;
                  break;

                case 18:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.eighteen++;
                  break;

                case 19:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.ninteen++;
                  break;

                case 20:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.twenty++;
                  break;

                case 21:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.twentyone++;
                  break;

                case 22:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.twenttwo++;
                  break;

                case 23:
                  this.dataindexmapped[Presentmonth].TimeSortedMonthly.twentythree++;
                  break;
              }
              ...
              if (i == this.data.length - 1) {
                this.dataindexmapped[Presentmonth].endx = i;

                for (var index = month; i <= 12; i++) {
                  this.dataindexmapped[year * 12 + index].start = i;
                  this.dataindexmapped[year * 12 + index].endx = i;
                }
            ...
            this.dataindexmapped[Presentmonth].days[day - 1]['VehicleCausingAccidentType'] = VehicleCausingAccidentType;
          }
    ...
    value: function findAndSetMinimumX() {
      ...
      for (var i = this.dataindexmapped[this.SmallestXIndex].id; i <= this.dataindexmapped[this.LargestXIndex].id; i++) {
        if (this.sortby == "") diff = this.dataindexmapped[i].endx - this.dataindexmapped[i].startx;else if (this.sortby == "VCausingType") diff = this.dataindexmapped[i].VehicleCausingAccidentTypeMonthly.a;else if (this.sortby == "time") {
          diff = 0;

          for (var j = this.knobstart; j <= this.knobend; j++) {
            switch (j) {
              case 0:
                diff += this.dataindexmapped[i].TimeSortedMonthly.zero;
                break;

              case 1:
                diff += this.dataindexmapped[i].TimeSortedMonthly.one;
                break;

              case 2:
                diff += this.dataindexmapped[i].TimeSortedMonthly.two;
                break;

              case 3:
                diff += this.dataindexmapped[i].TimeSortedMonthly.three;
                break;

              case 4:
                diff += this.dataindexmapped[i].TimeSortedMonthly.four;
                break;

              case 5:
                diff += this.dataindexmapped[i].TimeSortedMonthly.five;
                break;

              case 6:
                diff += this.dataindexmapped[i].TimeSortedMonthly.six;
                break;

              case 7:
                diff += this.dataindexmapped[i].TimeSortedMonthly.seven;
                break;

              case 8:
                diff += this.dataindexmapped[i].TimeSortedMonthly.eight;
                break;

              case 9:
                diff += this.dataindexmapped[i].TimeSortedMonthly.nine;
                break;

              case 10:
                diff += this.dataindexmapped[i].TimeSortedMonthly.ten;
                break;

              case 11:
                diff += this.dataindexmapped[i].TimeSortedMonthly.eleven;
                break;

              case 12:
                diff += this.dataindexmapped[i].TimeSortedMonthly.twelve;
                break;

              case 13:
                diff += this.dataindexmapped[i].TimeSortedMonthly.thirteen;
                break;

              case 14:
                diff += this.dataindexmapped[i].TimeSortedMonthly.forteen;
                break;

              case 15:
                diff += this.dataindexmapped[i].TimeSortedMonthly.fifteen;
                break;

              case 16:
                diff += this.dataindexmapped[i].TimeSortedMonthly.sixteen;
                break;

              case 17:
                diff += this.dataindexmapped[i].TimeSortedMonthly.seventeen;
                break;

              case 18:
                diff += this.dataindexmapped[i].TimeSortedMonthly.eighteen;
                break;

              case 19:
                diff += this.dataindexmapped[i].TimeSortedMonthly.ninteen;
                break;

              case 20:
                diff += this.dataindexmapped[i].TimeSortedMonthly.twenty;
                break;

              case 21:
                diff += this.dataindexmapped[i].TimeSortedMonthly.twentyone;
                break;

              case 22:
                diff += this.dataindexmapped[i].TimeSortedMonthly.twenttwo;
                break;

              case 23:
                diff += this.dataindexmapped[i].TimeSortedMonthly.twentythree;
                break;
            }
          }
        }
      ...
      this.smallestY = 0;
      if (this.sortby == "") this.largestY += 15;else this.largestY += 10;
      this.largestY = parseInt(this.largestY * 1.1);
    }
  }, {
    ...
    key: "renderBars",
    value: function renderBars(area, init) {
      if (this.sortby == "") return;else if (this.sortby == "VCausingType") {
        var path = "";
        var count = this.data[this.dataindexmapped[this.LargestXIndex].endx].year - this.data[this.dataindexmapped[this.SmallestXIndex].startx].year;
      }
    }
  }, {
    key: "renderGraph",
    value: function renderGraph(area, init) {
      if (this.sortby == "") {
        document.querySelector(".dataType").style.display = "none";

        if (this.wholeChart.querySelector('.VCausingTypea') != null) {
          this.wholeChart.querySelector('.VCausingTypea').setAttribute("d", "");
          this.wholeChart.querySelector('.VCausingTypeb').setAttribute("d", "");
          this.wholeChart.querySelector('.VCausingTypec').setAttribute("d", "");
          this.wholeChart.querySelector('.VCausingTyped').setAttribute("d", "");
          this.wholeChart.querySelector('.VCausingTypee').setAttribute("d", "");
          this.wholeChart.querySelector('.VCausingTypef').setAttribute("d", "");
          this.wholeChart.querySelector('.VCausingTypeg').setAttribute("d", "");
        }
        ...
        for (var i = 0; i < steps; i++) {
          init += incr;
          finalPath += "L " + init + " " + (1 - (this.dataindexmapped[i + this.SmallestXIndex].endx - this.dataindexmapped[i + this.SmallestXIndex].startx) / this.largestY) * this.height + " ";
        }

        this.wholeChart.querySelector('#maingraphPath').setAttribute("d", finalPath);
        ...
        for (var i = this.knobstart; i <= this.knobend; i++) {
          switch (i) {
            case 0:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.zero;
              break;

            case 1:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.one;
              break;

            case 2:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.two;
              break;

            case 3:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.three;
              break;

            case 4:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.four;
              break;

            case 5:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.five;
              break;

            case 6:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.six;
              break;

            case 7:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.seven;
              break;

            case 8:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.eight;
              break;

            case 9:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.nine;
              break;

            case 10:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.ten;
              break;

            case 11:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.eleven;
              break;

            case 12:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.twelve;
              break;

            case 13:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.thirteen;
              break;

            case 14:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.forteen;
              break;

            case 15:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.fifteen;
              break;

            case 16:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.sixteen;
              break;

            case 17:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.seventeen;
              break;

            case 18:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.eighteen;
              break;

            case 19:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.ninteen;
              break;

            case 20:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.twenty;
              break;

            case 21:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.twentyone;
              break;

            case 22:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.twenttwo;
              break;

            case 23:
              datacount += this.dataindexmapped[this.SmallestXIndex].TimeSortedMonthly.twentythree;
              break;
          }
        }

        finalPath += "M " + init + " " + (1 - datacount / this.largestY) * this.height + " ";
        ...
        for (var j = 0; j < steps; j++) {
          ...
          for (var i = this.knobstart; i <= this.knobend; i++) {
            switch (i) {
              case 0:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.zero;
                break;

              case 1:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.one;
                break;

              case 2:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.two;
                break;

              case 3:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.three;
                break;

              case 4:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.four;
                break;

              case 5:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.five;
                break;

              case 6:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.six;
                break;

              case 7:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.seven;
                break;

              case 8:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.eight;
                break;

              case 9:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.nine;
                break;

              case 10:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.ten;
                break;

              case 11:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.eleven;
                break;

              case 12:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.twelve;
                break;

              case 13:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.thirteen;
                break;

              case 14:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.forteen;
                break;

              case 15:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.fifteen;
                break;

              case 16:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.sixteen;
                break;

              case 17:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.seventeen;
                break;

              case 18:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.eighteen;
                break;

              case 19:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.ninteen;
                break;

              case 20:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.twenty;
                break;

              case 21:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.twentyone;
                break;

              case 22:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.twenttwo;
                break;

              case 23:
                datacount += this.dataindexmapped[this.SmallestXIndex + j].TimeSortedMonthly.twentythree;
                break;
            }
          }

          finalPath += "L " + init + " " + (1 - datacount / this.largestY) * this.height + " ";
        }

        this.wholeChart.querySelector('#maingraphPath').setAttribute("d", finalPath);
      } else if (this.sortby == "VCausingType") {
        this.wholeChart.querySelector('#maingraphPath').setAttribute("d", "");
        document.querySelector(".dataType").innerHTML = "";
        document.querySelector(".dataType").style.display = "flex";
        this.mainChartPath.setAttribute("d", "");
        var steps = this.subtractedFromFirst(this.data[this.dataindexmapped[this.LargestXIndex].endx], this.data[this.dataindexmapped[this.SmallestXIndex].startx]) + 1;
        var incr = area / steps;
        var finalPath = "";
        var gotinit = init;
        finalPath += "M " + init + " " + (1 - this.dataindexmapped[this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.a / this.largestY) * this.height + " ";

        for (var i = 0; i < steps; i++) {
          init += incr;
          finalPath += "L " + init + " " + (1 - this.dataindexmapped[i + this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.a / this.largestY) * this.height + " ";
        }

        document.querySelector(".dataType").innerHTML += "<div class='item'><div class='color' style='background:blue'></div>ट्रक / टीप्पर</div>";
        if (this.wholeChart.querySelector('.VCausingTypea') == null) this.wholeChart.innerHTML += "<path d='' class='VCausingTypea' stroke='blue' fill='none'></path>";
        this.wholeChart.querySelector('.VCausingTypea').setAttribute('d', finalPath);
        finalPath = "";
        init = gotinit;
        finalPath += "M " + init + " " + (1 - this.dataindexmapped[this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.b / this.largestY) * this.height + " ";

        for (var i = 0; i < steps; i++) {
          init += incr;
          finalPath += "L " + init + " " + (1 - this.dataindexmapped[i + this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.b / this.largestY) * this.height + " ";
        }

        document.querySelector(".dataType").innerHTML += "<div class='item'><div class='color' style='background:skyblue'></div>बस</div>";
        if (this.wholeChart.querySelector('.VCausingTypeb') == null) this.wholeChart.innerHTML += "<path d='' class='VCausingTypeb' stroke='skyblue' fill='none'></path>";
        this.wholeChart.querySelector('.VCausingTypeb').setAttribute('d', finalPath);
        finalPath = "";
        init = gotinit;
        finalPath += "M " + init + " " + (1 - this.dataindexmapped[this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.c / this.largestY) * this.height + " ";

        for (var i = 0; i < steps; i++) {
          init += incr;
          finalPath += "L " + init + " " + (1 - this.dataindexmapped[i + this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.c / this.largestY) * this.height + " ";
        }

        document.querySelector(".dataType").innerHTML += "<div class='item'><div class='color' style='background:green'></div>माइक्रो</div>";
        if (this.wholeChart.querySelector('.VCausingTypec') == null) this.wholeChart.innerHTML += "<path d='' class='VCausingTypec' stroke='green' fill='none'></path>";
        this.wholeChart.querySelector('.VCausingTypec').setAttribute('d', finalPath);
        finalPath = "";
        init = gotinit;
        finalPath += "M " + init + " " + (1 - this.dataindexmapped[this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.d / this.largestY) * this.height + " ";

        for (var i = 0; i < steps; i++) {
          init += incr;
          finalPath += "L " + init + " " + (1 - this.dataindexmapped[i + this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.d / this.largestY) * this.height + " ";
        }

        document.querySelector(".dataType").innerHTML += "<div class='item'><div class='color' style='background:red'></div>कर, भ्यान, जीप</div>";
        if (this.wholeChart.querySelector('.VCausingTyped') == null) this.wholeChart.innerHTML += "<path d='' class='VCausingTyped' stroke='red' fill='none'></path>";
        this.wholeChart.querySelector('.VCausingTyped').setAttribute('d', finalPath);
        finalPath = "";
        init = gotinit;
        finalPath += "M " + init + " " + (1 - this.dataindexmapped[this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.e / this.largestY) * this.height + " ";

        for (var i = 0; i < steps; i++) {
          init += incr;
          finalPath += "L " + init + " " + (1 - this.dataindexmapped[i + this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.e / this.largestY) * this.height + " ";
        }

        document.querySelector(".dataType").innerHTML += "<div class='item'><div class='color' style='background:pink'></div>मोटरसाइकल, स्कूटी</div>";
        if (this.wholeChart.querySelector('.VCausingTypee') == null) this.wholeChart.innerHTML += "<path d='' class='VCausingTypee' stroke='pink' fill='none'></path>";
        this.wholeChart.querySelector('.VCausingTypee').setAttribute('d', finalPath);
        finalPath = "";
        init = gotinit;
        finalPath += "M " + init + " " + (1 - this.dataindexmapped[this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.f / this.largestY) * this.height + " ";

        for (var i = 0; i < steps; i++) {
          init += incr;
          finalPath += "L " + init + " " + (1 - this.dataindexmapped[i + this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.f / this.largestY) * this.height + " ";
        }

        document.querySelector(".dataType").innerHTML += "<div class='item'><div class='color' style='background:black'></div>टय्मपो, टयाक्टर</div>";
        if (this.wholeChart.querySelector('.VCausingTypef') == null) this.wholeChart.innerHTML += "<path d='' class='VCausingTypef' stroke='black' fill='none'></path>";
        this.wholeChart.querySelector('.VCausingTypef').setAttribute('d', finalPath);
        finalPath = "";
        init = gotinit;
        finalPath += "M " + init + " " + (1 - this.dataindexmapped[this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.g / this.largestY) * this.height + " ";

        for (var i = 0; i < steps; i++) {
          init += incr;
          finalPath += "L " + init + " " + (1 - this.dataindexmapped[i + this.SmallestXIndex].VehicleCausingAccidentTypeMonthly.g / this.largestY) * this.height + " ";
        }

        document.querySelector(".dataType").innerHTML += "<div class='item'><div class='color' style='background:purple'></div>सरिरिक सकतीबाट चल्ने</div>";
        if (this.wholeChart.querySelector('.VCausingTypeg') == null) this.wholeChart.innerHTML += "<path d='' class='VCausingTypeg' stroke='purple' fill='none'></path>";
        this.wholeChart.querySelector('.VCausingTypeg').setAttribute('d', finalPath);
      }
    }
  }, {
    key: "generaterangeChanger",
    value: function generaterangeChanger(startval, endval) {
      var steps = endval - startval;
      this.knobstart = startval;
      this.knobend = endval;
      var totalLength = document.querySelector(".rangeChanger").getBoundingClientRect().width - 10;
      var incr = totalLength / steps;
      var initialval = 5;
      var path = "M 10 5 ";
      document.querySelector(".rangeChangerTexts").innerHTML = "";
      var that = this;

      for (var i = 0; i <= steps; i++) {
        path += "L " + initialval + " 5 L " + initialval + " 15 L " + initialval + " 5 ";
        document.querySelector(".rangeChangerTexts").innerHTML += "<text class='rangeChnger" + i + "' y=25>" + i + "</text>";
        var text = document.querySelector(".rangeChnger" + i);
        text.setAttribute("x", initialval - text.getBoundingClientRect().width / 2);
        initialval += incr;
      }

      document.querySelector(".rangeChangerPath").setAttribute("d", path);
      document.querySelector(".rangeChangerKnobs").style.display = "flex";
      document.querySelector(".firstknob").addEventListener("mousedown", function (e) {
        var prvright = document.querySelector(".rangeChangerKnobs").getBoundingClientRect().left + document.querySelector(".rangeChangerKnobs").getBoundingClientRect().width - document.querySelector(".rangeChanger").getBoundingClientRect().left - 10;
        var prvwidth = document.querySelector(".rangeChangerKnobs").getBoundingClientRect().width;
        var prvleft = document.querySelector(".rangeChangerKnobs").getBoundingClientRect().left - document.querySelector(".rangeChanger").getBoundingClientRect().left;
        var prvx = e.x;

        document.onmousemove = function (e) {
          var newx = e.x;
          var left = newx - prvx + prvleft;
          var width = -newx + prvx + prvwidth;

          if (left >= 0 && left <= prvright) {
            document.querySelector(".rangeChangerKnobs").style.left = left + "px";
            document.querySelector(".rangeChangerKnobs").style.width = width + "px";
            prvleft = left;
            prvwidth = width;
          }

          if (left >= prvright - 10) {
            document.querySelector(".firstknob").style.zIndex = 10;
          } else document.querySelector(".firstknob").style.zIndex = 0;

          prvx = newx;
        };

        document.onmouseup = function (e) {
          var pos = Math.floor((document.querySelector(".rangeChangerKnobs").getBoundingClientRect().left - document.querySelector(".rangeChanger").getBoundingClientRect().left) / incr);
          that.knobstart = pos;
          var change = document.querySelector(".rangeChangerKnobs").getBoundingClientRect().left - document.querySelector(".rangeChanger").getBoundingClientRect().left - pos * incr;
          document.querySelector(".rangeChangerKnobs").style.left = pos * incr + "px";
          document.querySelector(".rangeChangerKnobs").style.width = document.querySelector(".rangeChangerKnobs").getBoundingClientRect().width + change + "px";
          document.onmousemove = null;
          document.onmouseup = null;
          that.sortby = "time";
          that.generatePath(false);
      ...
      document.querySelector(".secondknob").addEventListener("mousedown", function (e) {
        var prvwidth = document.querySelector(".rangeChangerKnobs").getBoundingClientRect().width;
        var maxwidth = document.querySelector(".rangeChanger").getBoundingClientRect().width + document.querySelector(".rangeChanger").getBoundingClientRect().left - document.querySelector(".rangeChangerKnobs").getBoundingClientRect().left;
        var prvx = e.x;
        ...
        document.onmousemove = function (e) {
          ...
          if (width <= 20) {
            document.querySelector(".secondknob").style.zIndex = 10;
          } else document.querySelector(".secondknob").style.zIndex = 0;

          prvx = newx;
        };

        document.onmouseup = function (e) {
          var pos = Math.floor(document.querySelector(".rangeChangerKnobs").getBoundingClientRect().width / incr);
          that.knobend = pos;
          document.querySelector(".rangeChangerKnobs").style.width = pos * incr + 10 + "px";
          document.onmousemove = null;
          document.onmouseup = null;
          that.sortby = "time";
          that.generatePath(false);
    ...
    key: "listRendererInit",
    value: function listRendererInit() {
      var itemsLength = this.dataindexmapped[this.LargestXIndex].endx - this.dataindexmapped[this.SmallestXIndex].startx + 1;
      var top = document.querySelector(".one").getBoundingClientRect().height;
      document.querySelector(".allaccdata").style.height = itemsLength * 52 + top + "px";
    }
  }, {
    key: "listRenderer",
    value: function listRenderer() {
      var itemsLength = this.dataindexmapped[this.LargestXIndex].endx - this.dataindexmapped[this.SmallestXIndex].startx + 1;
      var top = document.querySelector(".one").getBoundingClientRect().height;
      var maxGeneratedItems = parseInt(window.innerHeight / 52);
      if (maxGeneratedItems % 2 != 0) maxGeneratedItems++;
      var initindexpos = this.dataindexmapped[this.SmallestXIndex].startx;
      var finalindexpos = this.dataindexmapped[this.LargestXIndex].endx - 1;
      var scrollTop = document.querySelector("[contentid='Add Data']").querySelector(".Content").scrollTop;

      for (var i = 0; i < maxGeneratedItems; i++) {
        var index = Math.floor((-maxGeneratedItems / 1.8 * 52 + scrollTop + (maxGeneratedItems - i) * 52) / (52 * maxGeneratedItems));
        if (index < 0) index = Math.floor((maxGeneratedItems / 1.8 * 52 + scrollTop + (maxGeneratedItems - i) * 52) / (52 * maxGeneratedItems));
        if (dataid > finalindexpos) return;
        var dataid = maxGeneratedItems * index + i + initindexpos;

        if (this.tableDataContent[i].id != dataid) {
          this.tableDataContent[i].style.top = top + (index * maxGeneratedItems + i) * 52 + "px";
          this.setDataInIndexAtTableIndex(dataid, i);
          this.tableDataContent[i].id = dataid;
        }
      }
    }
  }, {
    ...
    value: function showData(startIndex, count) {
      console.log(this.dataindexmapped[this.LargestXIndex].endx);
      console.log(this.dataindexmapped[this.SmallestXIndex].startx);
      this.listRendererInit();
      var that = this;
      document.querySelector("[contentid='Add Data']").querySelector(".Content").addEventListener("scroll", function () {
        that.listRenderer();
      });
      ...
      for (var i = start; i <= end; i++) {
        this.setDataInIndexAtTableIndex(i, index);
        index++;
      }

      this.listRenderer(); //document.querySelector("#sidebarAndSearchContainer").classList.remove("sidebarActive");
    }
  }, {
    key: "setDataInIndexAtTableIndex",
    value: function setDataInIndexAtTableIndex(dataindex, tableindex) {
      switch (this.data[dataindex].vehicleType) {
        case 0:
          this.tableDataContent[tableindex].querySelector(".Vtype").innerHTML = "ट्रक / टीप्पर";
          break;

        case 1:
          this.tableDataContent[tableindex].querySelector(".Vtype").innerHTML = "बस";
          break;

        case 2:
          this.tableDataContent[tableindex].querySelector(".Vtype").innerHTML = "माइक्रो";
          break;

        case 3:
          this.tableDataContent[tableindex].querySelector(".Vtype").innerHTML = "कर, भ्यान, जीप";
          break;

        case 4:
          this.tableDataContent[tableindex].querySelector(".Vtype").innerHTML = "मोटरसाइकल, स्कूटी";
          break;

        case 5:
          this.tableDataContent[tableindex].querySelector(".Vtype").innerHTML = "टय्मपो, टयाक्टर";
          break;

        case 6:
          this.tableDataContent[tableindex].querySelector(".Vtype").innerHTML = "सरिरिक सकतीबाट चल्ने";
          break;
      }

      switch (this.data[dataindex].Cause) {
        case 0:
          this.tableDataContent[tableindex].querySelector(".Cause").innerHTML = "चालकको लपरबाही";
          break;

        case 1:
          this.tableDataContent[tableindex].querySelector(".Cause").innerHTML = "तिभ्र गति";
          break;

        case 2:
          this.tableDataContent[tableindex].querySelector(".Cause").innerHTML = "मापासे";
          break;

        case 3:
          this.tableDataContent[tableindex].querySelector(".Cause").innerHTML = "यांत्रिक गडबाडी";
          break;

        case 4:
          this.tableDataContent[tableindex].querySelector(".Cause").innerHTML = "ओभरटके";
          break;

        case 5:
          this.tableDataContent[tableindex].querySelector(".Cause").innerHTML = "पैदल यात्रुको लापरबाही";
          break;

        case 6:
          this.tableDataContent[tableindex].querySelector(".Cause").innerHTML = "तडफोडबाट क्षती";
          break;

        case 7:
          this.tableDataContent[tableindex].querySelector(".Cause").innerHTML = "सडकको आबस्था";
          break;

        case 8:
          this.tableDataContent[tableindex].querySelector(".Cause").innerHTML = "अन्य (मौसम, चौपाया)";
          break;
      }

      switch (this.data[dataindex].VehicleCausingAccidentType) {
        case 0:
          this.tableDataContent[tableindex].querySelector(".VCausingType").innerHTML = "ट्रक / टीप्पर";
          break;

        case 1:
          this.tableDataContent[tableindex].querySelector(".VCausingType").innerHTML = "बस";
          break;

        case 2:
          this.tableDataContent[tableindex].querySelector(".VCausingType").innerHTML = "माइक्रो";
          break;

        case 3:
          this.tableDataContent[tableindex].querySelector(".VCausingType").innerHTML = "कर, भ्यान, जीप";
          break;

        case 4:
          this.tableDataContent[tableindex].querySelector(".VCausingType").innerHTML = "मोटरसाइकल, स्कूटी";
          break;

        case 5:
          this.tableDataContent[tableindex].querySelector(".VCausingType").innerHTML = "टय्मपो , टयाक्टर";
          break;

        case 6:
          this.tableDataContent[tableindex].querySelector(".VCausingType").innerHTML = "सरिरिक सकतीबाट चल्ने";
          break;
      }

      this.tableDataContent[tableindex].querySelector(".Time").innerHTML = this.data[dataindex].time.hour + ":" + this.data[dataindex].time.minutes;
      var date = this.data[dataindex].date.day + " ";

      switch (this.data[dataindex].date.month) {
        case 1:
          date += "बैसाख";
          break;
      ...
      date += ", ";
      date += this.data[dataindex].date.year;
      this.tableDataContent[tableindex].querySelector(".Date").innerHTML = date;
      var drivers = "";
      drivers += this.data[dataindex].DriverCausingAccident.age + " बार्से ";

      if (this.data[dataindex].DriverCausingAccident.gender) {
        drivers += "पुरुस";
      } else {
        drivers += "महिला";
      }

      this.tableDataContent[tableindex].querySelector(".DriverCausingAccident").innerHTML = drivers;
      drivers = "";
      drivers += this.data[dataindex].PeopleDead.age + " बार्से ";

      if (this.data[dataindex].PeopleDead.gender) {
        drivers += "पुरुस";
      } else {
        drivers += "महिला";
      }

      this.tableDataContent[tableindex].querySelector(".PeopleDead").innerHTML = drivers;

      switch (this.data[dataindex].Deaths) {
        case 0:
          this.tableDataContent[tableindex].querySelector(".Deaths").innerHTML = "पैदल यात्रु";
          break;

        case 1:
          this.tableDataContent[tableindex].querySelector(".Deaths").innerHTML = "मोटरसाइकिल / स्कूटी";
          break;

        case 2:
          this.tableDataContent[tableindex].querySelector(".Deaths").innerHTML = "ट्रक";
          break;

        case 3:
          this.tableDataContent[tableindex].querySelector(".Deaths").innerHTML = "साइकल";
          break;

        case 4:
          this.tableDataContent[tableindex].querySelector(".Deaths").innerHTML = "बस";
          break;

        case 5:
          this.tableDataContent[tableindex].querySelector(".Deaths").innerHTML = "माइक्रो";
          break;

        case 6:
          this.tableDataContent[tableindex].querySelector(".Deaths").innerHTML = "टय्मपो / टयाक्टर";
          break;

        case 7:
          this.tableDataContent[tableindex].querySelector(".Deaths").innerHTML = "कार";
          break;
      }
    }
  }, {
    ...
    value: function generatePeaks(init, area, moving) {
      var steps = this.subtractedFromFirst(this.data[this.dataindexmapped[this.LargestXIndex].endx], this.data[this.dataindexmapped[this.SmallestXIndex].startx]);
      var incr = area / steps;
      var path = "L " + init + " 2.5 L " + init + " 7.5 L " + init + " 2.5 ";
      var year = this.data[this.dataindexmapped[this.SmallestXIndex].startx].date.year;
      this.bottomAxisUnits.innerHTML += "<text x='0' id='btest'>8888-88</text>";
      var item = this.bottomAxisUnits.querySelector('#btest');
      var width = item.getBoundingClientRect().width;
      item.remove();
      var skip = parseInt(width * 2.2 / incr);
      var skipped = skip + 1;
      var text = year + '-' + this.data[this.dataindexmapped[this.SmallestXIndex].startx].date.month.toString();
      var id = text;
      this.vetline1.style.left = init + "px";
      this.bottomAxisUnits.innerHTML = "";
      var loopinit = this.subtractedFromFirst(this.data[this.dataindexmapped[this.SmallestXIndex].startx], this.mostSmallestX);
      var loopend = loopinit + steps;

      for (var i = loopinit; i <= loopend; i++) {
        if (skipped > skip || i % 12 == 0 || i == loopend) {
          if (i % 12 == 0 && i != 0) {
            year++;
          }

          if (i == loopend || i % 12 == 0 || i == loopinit) {
          ...
          if (moving && (i == loopinit || i == loopend)) item.setAttribute("stroke", '#1b5693');
...
function generateInitialHeatMap() {
  popup = new _Overlay.default({
    element: document.getElementById('heatDetail')
  });
  map.addOverlay(popup);
  var vectorSource = new ol.source.Vector();

  for (var i = 0; i < 100; i++) {
    var x = Math.random() * 0.1933 + 27.6066;
    var y = Math.random() * 0.3488 + 85.2199;
    var weight = Math.random() * 0.5 + 0.1;
    var feature = new ol.Feature({
      geometry: new ol.geom.Point(getESPG(x, y)),
      weight: weight + 0.4
    });
    feature.set('accis', weight);
    feature.set('type', 'heatpoint');
    vectorSource.addFeature(feature);
  }

  var rnd = Math.random() * 34;
  heat = new ol.layer.Heatmap({
    source: vectorSource,
    radius: rnd,
    blur: rnd - 3
  });
  ...
  map.addEventListener("pointermove", function (e) {
    ...
    if (feature != null) {
      if (feature.get('type') == 'heatpoint') {
        var coord = feature.getGeometry().getCoordinates();
        coord = ol.proj.transform(coord, 'EPSG:3857', 'EPSG:4326');
        document.querySelector("#heatDetail").innerHTML = coord[0].toFixed(3) + "° N, " + coord[1].toFixed(3) + "° E\nAverage accidents daiy: " + parseInt(feature.get('accis') * 20);
...
onloaded.push(generateInitialHeatMap);
var graph;

function addGraph(polygonPoints) {
  graph = new Graph(document.querySelector(".graphContainer"), document.querySelector(".allaccdata"));
  graphData = [];

  if (window.Worker) {
    var workerURL = URL.createObjectURL(new Blob(["generatePoints();" + generatePoints.toString()]));
    ...
    worker.postMessage(polygonPoints);
  } else {
    console.log("No web worker! Just DIE"); //graphData=generatePoints(polygonPoints);
    //graph.addData(graphData);
    //graph.generatePath();
    //showvehicleData();
  }
...
function generatePoints() {
  self.addEventListener("message", function (e) {
    ...
    for (var i = 0; i < polygonPoints.length; i++) {
      if (minx > polygonPoints[i].long) minx = polygonPoints[i].long;else if (maxx < polygonPoints[i].long) maxx = polygonPoints[i].long;
      if (miny > polygonPoints[i].lat) miny = polygonPoints[i].lat;else if (maxy < polygonPoints[i].lat) maxy = polygonPoints[i].lat;
    }
    ...
    for (var i = 0; i < 10000; i++) {
      ...
      while (!pointinside) {
        point = {
          long: minx + Math.random() * (maxx - minx),
          lat: miny + Math.random() * (maxy - miny)
        };

        if (findifpointliesinsidepolygon(polygonPoints, point)) {
          pointinside = true;
        }
      }

      workergraphData.push({
        point: point,
        ...
        time: {
          ...
          minutes: Math.floor(0 + Math.random() * 59)
        },
    ...
    self.postMessage(workergraphData);
  }, false);

  function findifpointliesinsidepolygon(polygonPoints, point) {
    var timeIntersected = 0;
    var len = polygonPoints.length;
    if (polygonPoints[len - 1].long == point.long && polygonPoints[len - 1].lat == point.lat) return true;
    if (findifLineSegsIntersect(polygonPoints[len - 1].long, polygonPoints[len - 1].lat, polygonPoints[0].long, polygonPoints[0].lat, point.long, point.lat, 1000, 1000)) timeIntersected++;

    for (var i = 1; i < len; i++) {
      if (polygonPoints[i - 1].long == point.long && polygonPoints[i - 1].lat == point.lat) return true;
      if (findifLineSegsIntersect(polygonPoints[i - 1].long, polygonPoints[i - 1].lat, polygonPoints[i].long, polygonPoints[i].lat, point.long, point.lat, 1000, 1000)) timeIntersected++;
    }

    if (timeIntersected % 2 == 0) return false;else return true;
  }

  function findifLineSegsIntersect(x11, y11, x12, y12, x21, y21, x22, y22) {
    var a1 = y12 - y11;
    var a2 = y22 - y21;
    var b1 = x11 - x12;
    var b2 = x21 - x22;
    var c1 = x11 * a1 + b1 * y11;
    var c2 = x21 * a2 + b2 * y21;
    var determinent = a1 * b2 - a2 * b1;
    if (determinent == 0) return false;else {
      var x = (b2 * c1 - b1 * c2) / determinent;
      var y = (a1 * c2 - a2 * c1) / determinent;
      if (Math.min(x11, x12) <= x && x <= Math.max(x11, x12) && Math.min(y11, y12) <= y && y <= Math.max(y11, y12) && Math.min(x21, x22) <= x && x <= Math.max(x21, x22)) return true;else return false;
    }
  }
} //onloaded.push(addGraph);
...
function setScrollbars() {
  var allitems = document.querySelectorAll(".sidebaritem");
  allitems.forEach(function (element) {
    element.querySelector(".Scrollbar").querySelector(".Knob").style.height = Math.pow(element.querySelector(".Content").getBoundingClientRect().height, 2) / element.querySelector(".Content").scrollHeight + "px";
    element.querySelector(".Content").addEventListener("scroll", function (e) {
      var content = element.querySelector(".Content");
      var scrollbar = element.querySelector(".Scrollbar");
      var knob = scrollbar.querySelector(".Knob");
      var totalheight = content.scrollHeight;
      var actualheight = element.getBoundingClientRect().height;
      knob.style.height = Math.pow(actualheight, 2) / totalheight + "px";
      knob.style.top = content.scrollTop * actualheight / totalheight + "px";
    });
  });
}

onloaded.push(setScrollbars); //#endregion
},{"ol/Overlay":"../node_modules/ol/Overlay.js","fs":"C:/Users/acer/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/_empty.js","ol/layer/Vector.js":"../node_modules/ol/layer/Vector.js","ol/source/Vector.js":"../node_modules/ol/source/Vector.js","ol/layer.js":"../node_modules/ol/layer.js","ol/style.js":"../node_modules/ol/style.js"}],"C:/Users/acer/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/acer/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index2.js"], null)
